...
| `env.FB_APP_ID` | For facebook channel, see [Facebook setup](https://developers.chatwoot.com/self-hosted/configuration/features/integrations/facebook-channel-setup) | `""` |
