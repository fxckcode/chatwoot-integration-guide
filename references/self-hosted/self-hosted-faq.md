...
Spamming channels with repetitive messages, Hijacking threads with unrelated promotional messages isn’t allowed and will be handled according to the [Code of Conduct](https://developers.chatwoot.com/contributing-guide/code-of-conduct#3-temporary-ban).
...
Run the following command from the [Rails Console](https://developers.chatwoot.com/self-hosted/monitoring/super-admin-sidekiq).
...
Run the following script from the [Rails Console](https://developers.chatwoot.com/self-hosted/monitoring/super-admin-sidekiq).
...
If you are still facing errors, Please check your Sidekiq worker logs or [Sidekiq UI](https://developers.chatwoot.com/self-hosted/monitoring/super-admin-sidekiq) for any errors.
