...
## **Running the campaign on the exact URL**[**​**](https://www.chatwoot.com/docs/product/features/campaigns/wild-card-url-in-campaigns/#running-the-campaign-on-the-exact-url "Direct link to Running the campaign on the exact URL")
...
* `https://chatwoot.com/app` would match `https://chatwoot.com/app/` or ``[https://chatwoot.com/app?test_param=1`](https://chatwoot.com/app?test_param=1%60)
...
## **Running the campaign ignoring the URL parameters**[**​**](https://www.chatwoot.com/docs/product/features/campaigns/wild-card-url-in-campaigns/#running-the-campaign-ignoring-the-url-parameters "Direct link to Running the campaign ignoring the URL parameters")
...
## **Running the campaign in all sub-directories**[**​**](https://www.chatwoot.com/docs/product/features/campaigns/wild-card-url-in-campaigns/#running-the-campaign-in-all-sub-directories "Direct link to Running the campaign in all sub-directories")
...
### **Running the campaign in all subdomains**[**​**](https://www.chatwoot.com/docs/product/features/campaigns/wild-card-url-in-campaigns/#running-the-campaign-in-all-subdomains "Direct link to Running the campaign in all subdomains")
